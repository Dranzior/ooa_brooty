inside_d2:connect_one_way_entrance(d2_bombed_terrace,function() return All(
...
inside_d2:connect_one_way_entrance(d2_moblin_drop,function() return All(
            ooa_can_kill_spiked_beetle(),
            ooa_can_kill_normal_enemy()
        ) end)
inside_d2:connect_one_way_entrance(d2_miniboss,function() return Any(
                All(
...
d2_miniboss:connect_one_way_entrance(d2_bombed_terrace,function() return All(
            ooa_can_jump_2_wide_pit(false),
            Any(
                ooa_has_bombs(),
                ooa_has_bombchus()
...
d2_miniboss:connect_one_way_entrance(d2_moblin_drop,function() return All(
            ooa_can_jump_2_wide_pit(false),
            ooa_can_kill_normal_enemy()
        ) end)
d2_miniboss:connect_one_way_entrance(d2_basement,function() return ooa_generic_boss_and_miniboss_kill() end)
...
inside_d2:connect_one_way_entrance(d2_rope_room,function() return All(
            ooa_can_kill_normal_enemy(true, true),
            ooa_has_small_keys(2, 4)) end)
inside_d2:connect_one_way_entrance(d2_ladder_chest,function() return All(
