inside_d4:connect_one_way_entrance(d4_first_chest,function() return All(
            Any(
...
inside_d4:connect_one_way_entrance(d4_minecart_A,function() return All(
...
d4_minecart_D:connect_one_way_entrance(d4_miniboss,function() return ooa_generic_boss_and_miniboss_kill() end)
d4_miniboss:connect_one_way_entrance(d4_small_floor_puzzle,function() return ooa_has_bombs() end)
d4_minecart_D:connect_one_way_entrance(d4_large_floor_puzzle,function() return All(
            ooa_can_jump_1_wide_liquid(false),
            ooa_has_switch_hook()) end)
d4_miniboss:connect_one_way_entrance(d4_large_floor_puzzle,function() return All(
