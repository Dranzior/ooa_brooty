inside_d7:connect_one_way_entrance(enter_d7_with_suit,function() return ooa_can_dive() end)
...
d7_drain:connect_one_way_entrance(d7_cane_and_diamond_puzzle,function() return All(
            ooa_has_long_hook(),
            ooa_has_cane()) end)
...
d7_stairway_chest:connect_one_way_entrance(d7_miniboss,function() return All(
            ooa_has_feather(),
            ooa_has_small_keys(7, 6),
            Any(
                ooa_has_sword(),
                ooa_has_boomerang(),
                All(
...
d7_miniboss:connect_one_way_entrance(d7_miniboss_chest,function() return ooa_has_small_keys(7, 7) end)
